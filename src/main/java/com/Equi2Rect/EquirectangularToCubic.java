...
//                  processImageFile(itr.next(), outputDir);
    ...
    public static BufferedImage[] processImage(BufferedImage equi) {
        ...
        //TODO: implement option to use custom width
        //width = 4000;
        verboseMode = true;
        ...
        pitch = 0;
        rectData = Equi2Rect.extractRectilinear(yaw,pitch,fov,equiData,rectWidth,rectHeight,equiWidth,bilinear,lanczos2);
        outputArray[0] = new BufferedImage(rectWidth, rectHeight, BufferedImage.TYPE_INT_RGB);
        outputArray[0].setRGB(0,0,rectWidth, rectHeight, rectData, 0, rectWidth);

        yaw = 90;
        pitch = 0;
        rectData = Equi2Rect.extractRectilinear(yaw,pitch,fov,equiData,rectWidth,rectHeight,equiWidth,bilinear,lanczos2);
        outputArray[1] = new BufferedImage(rectWidth, rectHeight, BufferedImage.TYPE_INT_RGB);
        outputArray[1].setRGB(0,0,rectWidth, rectHeight, rectData, 0, rectWidth);

        yaw = 180;
        pitch = 0;
        rectData = Equi2Rect.extractRectilinear(yaw,pitch,fov,equiData,rectWidth,rectHeight,equiWidth,bilinear,lanczos2);
        outputArray[2] = new BufferedImage(rectWidth, rectHeight, BufferedImage.TYPE_INT_RGB);
        outputArray[2].setRGB(0,0,rectWidth, rectHeight, rectData, 0, rectWidth);

        yaw = 270;
        pitch = 0;
        rectData = Equi2Rect.extractRectilinear(yaw,pitch,fov,equiData,rectWidth,rectHeight,equiWidth,bilinear,lanczos2);
        outputArray[3] = new BufferedImage(rectWidth, rectHeight, BufferedImage.TYPE_INT_RGB);
        outputArray[3].setRGB(0,0,rectWidth, rectHeight, rectData, 0, rectWidth);

        yaw = 0;
        pitch = 90;
        rectData = Equi2Rect.extractRectilinear(yaw,pitch,fov,equiData,rectWidth,rectHeight,equiWidth,bilinear,lanczos2);
        outputArray[4] = new BufferedImage(rectWidth, rectHeight, BufferedImage.TYPE_INT_RGB);
        outputArray[4].setRGB(0,0,rectWidth, rectHeight, rectData, 0, rectWidth);

        yaw = 0;
        pitch = -90;
        rectData = Equi2Rect.extractRectilinear(yaw,pitch,fov,equiData,rectWidth,rectHeight,equiWidth,bilinear,lanczos2);
        outputArray[5] = new BufferedImage(rectWidth, rectHeight, BufferedImage.TYPE_INT_RGB);
        outputArray[5].setRGB(0,0,rectWidth, rectHeight, rectData, 0, rectWidth);
